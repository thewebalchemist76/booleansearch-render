  ...
  const handleSearch = async () => {
    ...
    if (totalSearches > 20) {
      const confirmed = window.confirm(
        `Stai per fare ${totalSearches} ricerche. Ogni ricerca richiede 5-10 secondi.\n\n` +
    ...
    <div className="app">
      <div className="container">
        <header className="header">
          ...
          <p className="subtitle">Cerca articoli su più domini con Puppeteer su Render.com</p>
          <p className="info-text">⚡ Ogni ricerca richiede ~5-10 secondi</p>
        </header>
